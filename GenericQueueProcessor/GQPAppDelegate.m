...
//     [[GQPQueueProcessor sharedInstance]startTimerToCheckApplicationState];
    ...
    NSString *documentsDirectory = [NSSearchPathForDirectoriesInDomains(NSDocumentDirectory,
                                                                        NSUserDomainMask,
                                                                        YES) lastObject];
    NSString *logFolder = [documentsDirectory stringByAppendingPathComponent:@"QueueProcessorLogs"];
    
    
    
    [GSPKeychainStoreManager saveLogFilepathinKeychain:logFolder];
...
//    [[GQPQueueProcessor sharedInstance] getDataFormKeyChainAndProcess];
  ...
  NSString *filePath =   [GSPKeychainStoreManager getLogFilepathfromKeychain];
...
//        //
//        [[GQPQueueProcessor  sharedInstance]changePrioritytToLow];
//    });
